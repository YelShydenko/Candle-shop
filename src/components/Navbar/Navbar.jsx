      ...
      <div className="container">
        <div className="content">
          ...
          <div className="menu">
            ...
            <ul
              className={`navbar-list ${isToggle ? "navbar-list-active" : ""}`}
            >
              <li>
          ...
          <ul className="navbar-list">
            <li>
              <NavLink to="/authentication" className="navbar-list__item">
                <MdOutlinePersonOutline className="navbar-list__icon" />
              </NavLink>
            </li>
            <li>
              <NavLink to="/favourite" className="navbar-list__item">
                <HiMiniHeart className="navbar-list__icon" />{" "}
                <span className="count">{favourite.length}</span>
              </NavLink>
            </li>
            <li>
              <NavLink to="/cart" className="navbar-list__item">
                <MdOutlineShoppingCart className="navbar-list__icon" />{" "}
